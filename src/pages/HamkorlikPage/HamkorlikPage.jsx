            ...
            <div className="hamkorlik-page-content-left">
              ...
              <div className="hamkorlik-toggle-item">
                ...
                {!toggle2 && (<div className="hamkorlik-toggle-content">
                  ...
                  <p className="hamkorlik-toggle-content-opacity-text">
                    ...
                    International Education Society) xalqaro konferensiyasi –
                    “Illuminating
                    the Power of Idea / lism” <br/>
                    10.2022 – UNESCO - Jaxon Banki – “Malakali oʻqituvchi - malakali
                    millat:
                  ...
                  <p className="hamkorlik-toggle-content-opacity-text">
                    ...
                    08.2022 – 17.12.2022 – AQSH - Pittsburg universiteti, Kanzas
                    shtati <br/>
                    ...
                    Ltd. <br/>
                    26-29.09.2022 – Turkiya - Ta’lim boʻyicha global hamkorlik
                    tashkilotining
                    ...
                    05-10.07.2022 – Fransiya - Iqtisodiy hamkorlik va taraqqiyot
                    tashkiloti
                    (OECD) <br/>
              ...
              <div className="hamkorlik-toggle-item">
                ...
                {!toggle3 && (<div className="hamkorlik-toggle-content">
                  ...
                  <p className="hamkorlik-toggle-content-opacity-text">
                    Xalqaro rivojlanish tashkilotlari: <strong>7ta</strong> (UNESCO,
                    UNICEF,
                    JICA, American
                    ...
                    Mahalliy tashkilotlar: <strong>5 ta</strong> (Xorijiy tillar
                    agentligi,
                    Statistika
                    qoʻmitasi,Edu-Action taʻlim markazi, “Barkamol avlod” bolalar
                    maktablari, Nordik universiteti)<br/>
                    Turdosh institutlar va tashkilotlar: <strong>8 ta</strong> (KEDI,
                    KICE,
                    RAO, ISRO,
                  ...
                  <p className="hamkorlik-toggle-content-opacity-text">
                    ...
                    kasbga oʻqitish markazi (Bildungswerk der Sächsischen Wirtschaft
                    GGMBH)
                    ...
                    Respublikasi pedagog xodimlarning malakasini oshirish va qayta
                    tayyorlash
                  ...
                  <p><strong>Stajirovka dasturlarida qatnashgan Instituti xodimlari soni:
                    4
                    ta</strong></p>
                  <p className="hamkorlik-toggle-content-opacity-text">
                    15-29.01.2023 – <strong>Finlyandiya</strong> - Muuramedagi
                    tadbirkorlikka
                    ixtisoslashtirilgan yuqori maktabi, Yuvaskila shahrida joylashgan
                    Kuokkalan umumta’lim maktabi, Valteri maxsus ta’limga ehtiyojmand
                    bolalar
                    maktabi, GRADIA konsortiumiga kiruvchi yuqori maktab, Jyvaskyladagi
                    Keljonkanjas o‘rta maktabi, Finlyandiya Akademiyasi, Finlyandiya
                    ta’limni
                    baholash markazi.
                  </p>
                  <p><strong>Stajirovka dasturlarida qatnashgan Instituti xodimlari soni:
                    ...
                    ta</strong></p>
                  <p className="hamkorlik-toggle-content-opacity-text">
                    2023-yil 8-iyundan 2023-yilning 28-iyun sanasiga qadar <strong>Xitoy
                    Xalq
                    Respublikasining</strong> Savdo vazirligi tomonidan tashkil etilishi
                    rejalashtirilgan seminarlarda qatnashish uchun Institutning AKT va
                    texnik
                    ta’minot bo‘limi boshlig‘i <strong>Akmal
                    Boboqulovning</strong> stajirovka
                    oʻtashi ta’minlandi.
                  </p>
                  <p><strong>Xalqaro va Respublika miqyosidagi ilmiy-amaliy
                    konferensiyalar
                    soni: 2 ta </strong></p>
                  <p className="hamkorlik-toggle-content-opacity-text">
                    2023-yilning 15-16-sentabr sanalarida Estoniya davlatining Tallinn
                    shahrida tashkil etilgan xalqaro <strong>STEAM
                    konferensiyasi.</strong>
                    <br/>
                    2023-yilning 20-sentabrida Avloniy nomidagi milliy-tadqiqot
                    institutida
                    <strong>“Maktabgacha va maktab ta’limini samarali boshqarishning
                      demografik omillari”</strong> mavzusidagi ilmiy-amaliy
                    konferensiyasi.
                  </p>
                </div>)}
              </div>
