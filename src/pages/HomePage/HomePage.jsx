      ...
      <>
        ...
        <section className="slider">
          <div className="hero-slider">
            <video className="bg-video" autoPlay muted loop playsInline id="bg-video">
              ...
              <div className="container">
                <div className="row align-items-center">
                  <div className="col-lg-6">
                    <div className="text">
                      <h1 style={{color: "#f3e2a5"}}>NAMANGAN VILOYATI <br/> PEDAGOGIK
                        MAHORAT
                        MARKAZI
                      </h1>
                      <p style={{color: "#fff", fontSize: "18px"}}>Bizning asosiy
                        maqsadimiz -
                        zamonaviy, ilg'or
                        va samarali ta'lim metodikalarini rivojlantirish orqali
                        pedagoglarning
                    ...
                    <div className="circular-loop">
                      ...
                      <div className="circle">
                        ...
                        <div className="loop-item"
                             style={{
                               backgroundColor: "#8690EE",
                             }}>
                          <div className="loop-item-inner" style={{gap: 0}}>
                            <span style={{color: "#000"}}>Barqarorlik</span>
                            <img src={stability} alt=""/>
                          </div>
                        </div>
                        <div className="loop-item" style={{backgroundColor: "#CFAB20"}}>
                          <div className="loop-item-inner">
                            <img src={justice} alt=""/>
                            <span style={{color: "#000"}}>Adolat</span>
                          </div>
                        </div>
                        <div className="loop-item" style={{backgroundColor: "#0B1E72"}}>
                          <div className="loop-item-inner">
                            <span>Yangi <br/> G'oyalar</span>
                            <img src={ideas} alt=""/>
                          </div>
                        </div>
                        <div className="loop-item" style={{backgroundColor: "#CFAB20"}}>
                          <div className="loop-item-inner">
                            ...
                            <span style={{color: "#000"}}>Ma'suliyat</span>
                          </div>
                        </div>
        ...
        <section id="teachers">
          <div className="container">
            <div className="teachers-section-wrapper">
              <div className="teachers-section-header">
                <h1>Faol Ustozlar</h1>
              </div>
              <div className="teachers-section-body">
                <OwlCarousel
                    ref={teachersSlider}
              ...
              <div className="teachers-section-footer">
                <button className="teacher-slider-toggle" id="teacher-slider-left"
                        onClick={() => teachersSlider.current.prev()}>
                  <i className="fa-solid fa-left-long"></i>
                </button>
                <div id="teachers-dots"></div>
                <button className="teacher-slider-toggle" id="teacher-slider-right"
                        onClick={() => teachersSlider.current.next()}>
              ...
              <svg viewBox="0 0 792.4873 516.87848">
                <path
                    style={{
                      ...
                      strokeWidth: "1.08936px",
                      strokeOpacity: 1,
                      fill: "rgba(228, 228, 228, 0)"
                    }}
                    ...
                    className="water mapsvg-region mapsvg-disabled mapsvg-disabled"
                    title="Aral Sea"
                    id="UZ-AS"
                >
                </path>
                ...
                <path
                    ...
                    title="Buxoro"
                    id="UZ-BU"
                    className="mapsvg-region mapsvg-disabled mapsvg-disabled"
                    style={{
                      fill: "#1a76d1",
                      stroke: "rgb(255, 255, 255)",
                      strokeWidth: "2.61446px"
        ...
        <div className="president-quote-wrapper">
          ...
          <div className="president-quote">
            <p>Ta'lim-tarbiya sohasida zamonaviy va oqilona tizim yaratish, o'qitish
              ...
              zarur. Bilim berishda ilg'or xorijiy tajribalardan foydalanish, tarbiyada
              esa
