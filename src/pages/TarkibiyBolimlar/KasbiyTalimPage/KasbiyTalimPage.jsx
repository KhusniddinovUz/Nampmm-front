...
import ozoda from "../../../assets/teachers/ozoda.JPG";
import sirojiddin from "../../../assets/teachers/sirojiddin.JPG";

const KasbiyTalimPage = () => {
  return (
        ...
        <div className="main-page-content-wrapper">
          <section id="leadership-header">
            ...
            <div className="header-content">
              ...
              <h2>Uzluksiz kasbiy ta'limni tashkil etish</h2>
            </div>
          </section>
          ...
          <section className="main-page-content">
            <div className="main-page-content-left">
              <div className="row">
                <TeacherComponent
                    title="Uzluksiz kasbiy ta’limni tashkil etish bo‘limi boshlig‘i"
                    image={ozoda}
                    name="Xudayberdiyeva Ozoda Jurabayevna"/>
                <TeacherComponent
                    title="Uzluksiz kasbiy ta’limni tashkil etish bo‘limi bosh mutaxassisi"
                    image={sirojiddin}
                    name="Murodov Sirojiddin Boxodir o‘g‘li"/>
...
export default KasbiyTalimPage;
