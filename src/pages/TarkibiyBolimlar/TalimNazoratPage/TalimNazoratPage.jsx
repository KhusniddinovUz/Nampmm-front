...
import davronbek from "../../../assets/teachers/davronbek.JPG";
import nargiza from "../../../assets/teachers/nargiza.JPG";

const TalimNazoratPage = () => {
  return (
        ...
        <div className="main-page-content-wrapper">
          <section id="leadership-header">
            ...
            <div className="header-content">
              ...
              <h2>Ta'lim sifati nazorati bo'limi</h2>
            </div>
          </section>
          ...
          <section className="main-page-content">
            <div className="main-page-content-left">
              <div className="row">
                <TeacherComponent
                    title="Ta’lim sifati nazorati bo‘limi boshlig‘i"
                    image={nargiza}
                    name="Kirgizova Nargiza Xudayberdiyevna "/>
                <TeacherComponent
                    title=" Ta’lim sifati nazorati bo‘limi bosh mutaxassisi"
                    image={davronbek}
                    name="Mallayev Davronbek Abdullajonovich"/>
...
export default TalimNazoratPage;
