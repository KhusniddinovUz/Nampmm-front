...
import doniyor from "../../../assets/teachers/doniyor.JPG";

const AkademikFaoliyatPage = () => {
  return (
        ...
        <div className="main-page-content-wrapper">
          <section id="leadership-header">
            ...
            <div className="header-content">
              ...
              <h2>Raqamli texnologiyalarni rivojlantirish bo'limi</h2>
            </div>
          </section>
          ...
          <section className="main-page-content">
            <div className="main-page-content-left">
              <div className="row">
                <TeacherComponent
                    title="Raqamli texnologiyalarni rivojlantirish bo‘limi bosh mutaxassisi"
                    image={doniyor}
                    name="Voxabov Doniyor Ibroximovich"/>
                <TeacherComponent
                    title="Raqamli texnologiyalarni rivojlantirish bo‘limi yetakchi mutaxassisi "
                    image={user}
                    name="Topildiyeva Odinaxon Abdulaziz qizi"/>
...
export default AkademikFaoliyatPage;
