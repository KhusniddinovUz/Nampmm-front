        ...
        <div className="main-page-content-wrapper">
          <section id="leadership-header">
            ...
            <div className="header-content">
              ...
              <h2>Maktabgacha ta'limni muvofiqlashtirish bo'limi</h2>
            </div>
          </section>
          ...
          <section className="main-page-content">
            <div className="main-page-content-left">
              <div className="row">
                <TeacherComponent
                    title="Maktabgacha ta’limni muvofiqlashtirish bo‘limi boshlig‘i"
                    image={user}
                    name="Qambarova Naziraxon Barxonovna"/>
                <TeacherComponent
                    title="Maktabgacha ta’limni muvofiqlashtirish bo‘limi yetakchi mutaxassisi"
                    image={user}
                    name="Davlatov Javlonboy Nurmuxammad o‘g‘li"/>
...
export default MaktabgachaTalimPage;
