        ...
        <div className="main-page-content-wrapper">
          <section id="leadership-header">
            ...
            <div className="header-content">
              ...
              <h2>Moliya iqtisod va buxgalteriya bo'limi</h2>
            </div>
          </section>
          ...
          <section className="main-page-content">
            <div className="main-page-content-left">
              <div className="row">
                <TeacherComponent
                    title="Moliya-iqtisod va buxgalteriya bo‘limi boshlig‘i"
                    image={user}
                    name=" Ismatov Xusnitdin Komiljonovich"/>
                <TeacherComponent
                    title="Moliya-iqtisod va buxgalteriya bo‘limi bosh mutaxassisi"
                    image={user}
                    name="Abdullayev Baxodir Raximovich"/>
                <TeacherComponent
                    title="Moliya-iqtisod va buxgalteriya bo‘limi yetakchi mutaxassis"
                    image={user}
                    name=" Nazarov Axmadjon Raximjonovich"/>
