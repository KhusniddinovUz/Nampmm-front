...
import maxamadali from "../../../assets/teachers/maxamadali.jpg";
        ...
        <div className="main-page-content-wrapper">
          <section id="leadership-header">
            ...
            <div className="header-content">
              ...
              <h2>Akademik faoliyatni muvofiqlashtirish bo'limi</h2>
            </div>
          </section>
          ...
          <section className="main-page-content">
            <div className="main-page-content-left">
              <div className="row">
                <TeacherComponent
                    title="Akademik faoliyatini muvofiqlashtirish bo‘limi boshlig‘i"
                    image={user}
                    name="Nurmatov Ilxom Ismoilovich"/>
                <TeacherComponent
                    title="Akademik faoliyatini muvofiqlashtirish bo‘limi bosh mutaxassisi"
                    image={maxamadali}
                    name="Muminov Maxamadali Islamjanovich"/>
