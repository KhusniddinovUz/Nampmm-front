...
import malikabdulaziz from "../../../assets/teachers/malikabdulaziz.jpg";
    ...
    <div className="main-page-content-wrapper">
      <section id="leadership-header">
        ...
        <div className="header-content">
          ...
          <h2>Fanlarni rivojlantirish bo'limi</h2>
        </div>
      </section>
      ...
      <section className="main-page-content">
        <div className="main-page-content-left">
          <div className="row">
            <TeacherComponent
                title="Fanlarni rivojlantirish bo‘limi boshlig‘i"
                image={malikabdulaziz}
                name="Akbaraliyev Malikabdulaziz Mirabdulla o‘g‘li"/>
            <TeacherComponent
                title="Fanlarni rivojlantirish bo‘limi bosh mutaxassisi"
                image={user}
                name="Murodxo‘jayev Saidbek G‘ulomjon o‘g‘li"/>
